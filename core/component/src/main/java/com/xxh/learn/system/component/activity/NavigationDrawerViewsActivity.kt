...
import com.xxh.learn.system.component.databinding.ActivityNavigationDrawerViewsBinding
...
class NavigationDrawerViewsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val navController =
            findNavController(R.id.nav_host_fragment_content_navigation_drawer_views)
