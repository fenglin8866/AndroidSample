...
import com.xxh.summary.lifecycle.source.viewmodel.AndroidViewModel
import com.xxh.summary.lifecycle.source.viewmodel.CreationExtras
import com.xxh.summary.lifecycle.source.viewmodel.ViewModel
import com.xxh.summary.lifecycle.source.viewmodel.ViewModelProvider
import com.xxh.summary.lifecycle.source.viewmodel.ViewModelProvider.AndroidViewModelFactory.Companion.getInstance
import com.xxh.summary.lifecycle.source.viewmodel.ViewModelProvider.NewInstanceFactory.Companion.instance
 ...
 *
 * If ViewModel is instance of [AndroidViewModel], it looks for a
 ...
 * [AndroidViewModel] is only supported if you pass a non-null
...
class SavedStateViewModelFactory : ViewModelProvider.OnRequeryFactory, ViewModelProvider.Factory {
     ...
     *
     * [ViewModel] created with this factory can access to saved state
