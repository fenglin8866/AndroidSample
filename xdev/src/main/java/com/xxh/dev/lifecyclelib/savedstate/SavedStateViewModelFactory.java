...
import static com.xxh.dev.lifecyclelib.savedstate.AbstractSavedStateViewModelFactory.TAG_SAVED_STATE_HANDLE_CONTROLLER;
...
import com.xxh.dev.lifecyclelib.viewmode.AndroidViewModel;
import com.xxh.dev.lifecyclelib.viewmode.ViewModel;
import com.xxh.dev.lifecyclelib.viewmode.ViewModelProvider;

/**
 * {@link ViewModelProvider.Factory} that can create ViewModels accessing and
 ...
 * <p>
 * If ViewModel is instance of {@link AndroidViewModel}, it looks for a
 ...
 * {@link AndroidViewModel} is only supported if you pass a non-null
...
public final class SavedStateViewModelFactory extends ViewModelProvider.KeyedFactory {
     ...
     * <p>
     * {@link ViewModel} created with this factory can access to saved state
    ...
    public void onRequery(@NonNull ViewModel viewModel) {
        SavedStateHandleController.attachHandleIfNeeded(viewModel, mSavedStateRegistry, mLifecycle);
    }
}
